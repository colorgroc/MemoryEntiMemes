...
class MenuScene: SKScene, ButtonDelegate, ImageButtonDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        if let playButton = playButton{
            ...
            playButton.run(SKAction.fadeIn(withDuration: 0.7))
            addChild(playButton)
        ...
        soundButton.run(SKAction.fadeIn(withDuration: 0.7))
        ...
        if let aboutButton = aboutButton{
            ...
            aboutButton.run(SKAction.fadeIn(withDuration: 0.7))
        ...
        gameImage.alpha = 0.0
        gameImage.run(SKAction.fadeIn(withDuration: 0.5))
        addChild(gameImage)
